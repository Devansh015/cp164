...
class Sorted_List:
    ...
    def _is_valid_index(self, i):
        ...
        if i in range(-len(self._values), len(self._values) - 1):
            valid = True
        else:
            valid = False
    ...
    def intersection(self, source1, source2):
        ...
        for value in source1._values:
            if value in source2._values and value not in intersected:
                intersected.append(value)
        
        self._values = deepcopy(intersected)
    ...
    def __eq__(self, target):
        ...
        if len(target._values) == len(self._values):
            for a in range(len(self._values)):
                if target._values[a] == self._values[a]:
                    equals = True
                else: 
                    equals = False
                    break
    ...
    def split(self):
        ...
        while self._values:
            target1._values.append(self.remove_front())
    ...
    def split_alt(self):
        ...
        while self._values:
            target1._values.append(self.remove_front())
            if len(self._values) != 0:
                target2._values.append(self.remove_front())
    ...
    def union(self, source1, source2):
        ...
        for value in source1._values:
            if value in source2._values and value not in union:
                union.append(value)
        
        self._values = deepcopy(union)
