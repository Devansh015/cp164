...
class List:
    ...
    def intersection(self, source1, source2):
        ...
        for i in source1:
            if i in source2 and i not in self._values:  # note to self: condition && condition
    ...
    def split(self):
        ...
        if len(self._values) > 0:
            ...
            for i in range(len(self._values)):
                if i < mid_index:
                    array1.append(self._values[i])
                else:
                    array2.append(self._values[i])
    ...
    def split_alt(self):
        ...
        while not self.is_empty():
            if swap:
                if not array1.is_empty():
                    array1.append(self._values.pop(0))
                else:
                    array2.append(self._values.pop(0))
            else:
                if not array2.is_empty():
                    array2.append(self._values.pop(0))
                else:
                    array1.append(self._values.pop(0))
            swap = not swap
        self._values = []  # clean list
        return array1, array2
