...
class List:
    ...
    def insert(self, i, value):
        ...
        -------------------------------------------------------
        """
        if self._front is None or i == 0 or i <= -self._count:
            ...
            while counter < i - 1 and temp is not None:
            ...
            new_node = _List_Node(value, temp)
    ...
    def _reverse_r_aux(self, current, previous=None):
        if current is None:
            ...
            next = current._next
            current._next = previous
            result = self._reverse_r_aux(next, current)
    ...
    def _is_identical_r_aux(self, curr, other):
        ...
        elif curr is not None and other is not None and curr._value == other._value:
            identical = self._is_identical_r_aux(curr._next, other._next)
    ...
    def split(self):
        ...
        while current is not None and i < mid:
    ...
    def split_alt_r(self):
        ...
        self._split_alt_r_aux(self._front, 0, even, odd)
        self._front = None
        self._rear = None
        return even, odd

    def _split_alt_r_aux(self, current, index, even, odd):
        if current is not None:
            ...
            self._split_alt_r_aux(next_node, index + 1, even, odd)
    ...
    def _union_r_aux(self, node):
        ...
        if node is not None:
            ...
            if current is None:
                self.append(deepcopy(node._value))
